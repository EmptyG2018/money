  ...
  const TOPIC_MAP = {
    1: ({ count, key }) => (
      <Card.Grid hoverable={false} key={key}>
        <ActionGrid to={`/exam/exercise/tmlxkm/${params.id}?topic_type=1`}>
    ...
    2: ({ count, key }) => (
      <Card.Grid hoverable={false} key={key}>
        <ActionGrid to={`/exam/exercise/tmlxkm/${params.id}?topic_type=2`}>
    ...
    3: ({ count, key }) => (
      <Card.Grid hoverable={false} key={key}>
        <ActionGrid to={`/exam/exercise/tmlxkm/${params.id}?topic_type=3`}>
    ...
    4: ({ count, key }) => (
      <Card.Grid hoverable={false} key={key}>
        <ActionGrid to={`/exam/exercise/tmlxkm/${params.id}?topic_type=4`}>
    ...
    5: ({ count, key }) => (
      <Card.Grid hoverable={false} key={key}>
        <ActionGrid to={`/exam/exercise/tmlxkm/${params.id}?topic_type=5`}>
    ...
    6: ({ count, key }) => (
      <Card.Grid hoverable={false} key={key}>
        <ActionGrid to={`/exam/exercise/tmlxkm/${params.id}?topic_type=6`}>
    ...
    7: ({ count, key }) => (
      <Card.Grid hoverable={false} key={key}>
        <ActionGrid to={`/exam/exercise/tmlxkm/${params.id}?topic_type=7`}>
